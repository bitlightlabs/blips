...
| 828/829 | `rgb_recovery`         | This node implements the RGBR disaster-recovery protocol   | IN      | `rgb_channel`           | [bLIP XX](./blip-rgb-recovery.md) |
...
| 60001   | `rgbr_query_channel_close`      | [bLIP XX](./blip-rgb-recovery.md) |
| 60003   | `rgbr_channel_close_info`       | [bLIP XX](./blip-rgb-recovery.md) |
| 60005   | `rgbr_error`                    | [bLIP XX](./blip-rgb-recovery.md) |
